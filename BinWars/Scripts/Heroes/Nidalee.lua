...
[     0] pe:AddParticle(self,'Nidalee_Base_P_Buf.troy') --Applied to target
[     0] pe:AddParticle(self,'Nidalee_Base_Q_Buf.troy') --Applied to self
[     0] pe:AddParticle(self,'Nidalee_Base_Q_Tar.troy') --Applied to self
