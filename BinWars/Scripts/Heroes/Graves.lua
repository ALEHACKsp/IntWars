function CastSpell(self,spellIndex,x,y)
	if spellIndex == 0 then 
		...
		--self:SetSpellName(51,'GravesClusterShotSoundMissile')
                ...
                --build missile, with end position etc
                m1 = spell:AddMissile(self,'GravesClusterShotAttack',0.25) --0.967231,0.000000,0.253897
                m1.x = x-100
                m1.y = y-100
                spell:AddMissile(self,'GravesClusterShotSoundMissile',0.25) --0.967231,0.000000,0.253896
                m2 = spell:AddMissile(self,'GravesClusterShotAttack',0.25) --0.999746,0.000000,-0.022544
                m3 = spell:AddMissile(self,'GravesClusterShotAttack',0.25) --0.859779,0.000000,0.510666
                m3.x = x+100
                m3.y = y+100
